...
public  final class Ad extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return searchAds.internal_static_adindex_Ad_descriptor;
  }

  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return searchAds.internal_static_adindex_Ad_fieldAccessorTable
  ...
  public boolean equals(final Object obj) {
    ...
    result = result && (
        Double.doubleToLongBits(getRelevanceScore())
        == Double.doubleToLongBits(
            other.getRelevanceScore()));
    result = result && (
        Double.doubleToLongBits(getPClick())
        == Double.doubleToLongBits(
            other.getPClick()));
    result = result && (
        Double.doubleToLongBits(getBidPrice())
        == Double.doubleToLongBits(
            other.getBidPrice()));
    result = result && (
        Double.doubleToLongBits(getRankScore())
        == Double.doubleToLongBits(
            other.getRankScore()));
    result = result && (
        Double.doubleToLongBits(getQualityScore())
        == Double.doubleToLongBits(
            other.getQualityScore()));
    result = result && (
        Double.doubleToLongBits(getCostPerClick())
        == Double.doubleToLongBits(
