...
public  final class Query extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.yufeiz.adindex.searchAds.internal_static_adindex_Query_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.yufeiz.adindex.searchAds.internal_static_adindex_Query_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.yufeiz.adindex.Query.class, io.yufeiz.adindex.Query.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.yufeiz.adindex.Query)) {
      return super.equals(obj);
    }
    io.yufeiz.adindex.Query other = (io.yufeiz.adindex.Query) obj;
  ...
  public static io.yufeiz.adindex.Query parseFrom(
  ...
  public static io.yufeiz.adindex.Query parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.yufeiz.adindex.Query parseFrom(
  ...
  public static io.yufeiz.adindex.Query parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.yufeiz.adindex.Query parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.yufeiz.adindex.Query parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.yufeiz.adindex.Query prototype) {
  ...
  public static final class Builder extends
      ...
      io.yufeiz.adindex.QueryOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.yufeiz.adindex.searchAds.internal_static_adindex_Query_descriptor;
    }
    ...
    // Construct using io.yufeiz.adindex.Query.newBuilder()
    private Builder() {
    ...
    public io.yufeiz.adindex.Query getDefaultInstanceForType() {
      return io.yufeiz.adindex.Query.getDefaultInstance();
    }

    public io.yufeiz.adindex.Query build() {
      io.yufeiz.adindex.Query result = buildPartial();
    ...
    public io.yufeiz.adindex.Query buildPartial() {
      io.yufeiz.adindex.Query result = new io.yufeiz.adindex.Query(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.yufeiz.adindex.Query) {
        return mergeFrom((io.yufeiz.adindex.Query)other);
      } else {
    ...
    public Builder mergeFrom(io.yufeiz.adindex.Query other) {
      if (other == io.yufeiz.adindex.Query.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.yufeiz.adindex.Query parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.yufeiz.adindex.Query) e.getUnfinishedMessage();
  ...
  private static final io.yufeiz.adindex.Query DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.yufeiz.adindex.Query();
  }

  public static io.yufeiz.adindex.Query getDefaultInstance() {
